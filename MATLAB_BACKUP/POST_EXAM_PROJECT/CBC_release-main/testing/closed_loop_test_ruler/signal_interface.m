classdef signal_interface < dspace_interface_XILAPI
    ...
    methods
        function obj = signal_interface(maPortConfigFile)
            ...
            obj.add_dspace_var('target_vec', 'Model Root/target_vec/Value');  % fund freq
            ...
            obj.add_dspace_var('ref_vec', 'Model Root/ref_vec/Out1');  %reference vector

            %control and safety
            obj.add_dspace_var('test_vec', 'Model Root/test_value/Value');
            obj.add_dspace_var('target_amp', 'Model Root/target_amp/Value');
            obj.add_dspace_var('target_adjustments', 'Model Root/target_adjustments/Value');
            ...
            obj.add_dspace_var('ss_trigger', 'Model Root/SS_trigger/Value');
            ...
            % obj.datafields.dynamic_fields = {'fund_amp','fund_frequency','force_in1','disp_in2','acc_in3',...
            %     'target_amp','control_switch', 'input_thresh', 'displacement_thresh',...
            %     'controller_Kp', 'controller_Kd', 'controller_Ki', 'ss_trigger', 'Q1', 'Q2', 'R_matrix',...
            %     'sig_amp', 'res_amp', 'invasiveness'} ;
