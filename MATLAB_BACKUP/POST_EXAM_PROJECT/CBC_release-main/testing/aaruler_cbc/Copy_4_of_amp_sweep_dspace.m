...
rtc.par.controller_Kd = 0.002;
rtc.par.controller_Kp = 0.21;
rtc.par.controller_Ki = 0.0000;

% target_range = 15:-0.2:1;
...
fname = sprintf("s_curve_unstable_freq_%s.mat", freq_str);
fname2 = sprintf("conds_s_curve_unstable_freq_%s.mat", freq_str);
